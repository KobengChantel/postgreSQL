...
-- Revise the code in Listing 12-15 to dig deeper into the nuances of Waikiki’s
-- high temperatures Limit the temps_collapsed table to the Waikiki maximum
-- daily temperature observations Then use the WHEN clauses in the CASE state-
-- ment to reclassify the temperatures into seven groups that would result in
...
-- other words, make flavor the rows and office the columns Which ele-
-- ments of the query do you need to change? Are the counts different
