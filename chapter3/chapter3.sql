...
VALUES 
 ...
 COPY char_data_types TO 'C:\Bootcamp\SQL\my_work\typetest.txt'
...
--3.4 Timestamp and interval types in action
CREATE TABLE date_time_types (
 timestamp_column timestamp with time zone,
 interval_column interval
);
--Understanding Data Types 33
...
-- Listing 3-5: Using the interval data 
SELECT
    timestamp_column,
    interval_column,
